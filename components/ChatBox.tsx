  ...
  return (
    ...
    >
       <style>{`
        ...
        `}</style>
      <div
        className="w-full sm:w-11/12 max-w-6xl h-[80vh] sm:h-3/4 md:h-5/6 lg:h-[85vh] flex flex-col bg-slate-900/90 rounded-t-lg sm:rounded-lg border-2 border-cyan-400/50 shadow-2xl shadow-cyan-400/20 overflow-hidden animate-slideUp"
